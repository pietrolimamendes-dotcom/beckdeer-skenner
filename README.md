...
A decent script utility that supports most of UNC functions (such as filesystem functions) and all of Luau features.
Comparison
...
Please refer to this link: How to add a backdoor

Do you log any of the sensitive information and/or backdoored games?
No, I respect the privacy of everyone who uses the script and refrain from engaging in any of those malicious practices. You can check the script's source code to verify its authenticity.
